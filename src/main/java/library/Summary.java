...
public class Summary {
   ...
   */
  public Summary(JProgressBar a_pbar, JLabel a_Progresslabel, JProgressBar a_pbar1) {
    m_pbar = a_pbar;
  ...
  public ArrayList<String> TripsSummary() {
    ...
    try {
      ...
      m_VerwerkteTracks = 0;
      m_pbar.setMaximum(m_AantalTracks);
      ...
      v_tracks.forEach(v_track -> {
        ...
        m_pbar1.setMaximum(m_AantalSegments);
        m_pbar1.setVisible(true);
  ...
  private void verwerkProgressSegments() {
    ...
    try {
      ...
      Integer v_iprog = v_prog.intValue();
      m_ProgressLabel
          .setText(v_iprog.toString() + "% (" + m_AantalSegments + " van " + m_AantalSegments + " segments)");
    } catch (Exception e) {
    }
  }
}
